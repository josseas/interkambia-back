...
let ModuleController = ModuleController_1 = class ModuleController {
    constructor(moduleService) {
        ...
        this.logger = new common_1.Logger(ModuleController_1.name);
    }
    async getModules() {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_a = typeof module_dto_1.CreateModuleDto !== "undefined" && module_dto_1.CreateModuleDto) === "function" ? _a : Object]),
    __metadata("design:returntype", Promise)
], ModuleController.prototype, "create", null);
ModuleController = ModuleController_1 = __decorate([
